...
public class base_setup_max extends StarMacro {

  // Set name of waverider geometry 
  String waverider_name="waverider_GCS";
  String cad_filename= waverider_name + ".step";
  String save_filename="waverider_GCS_max";
  ...
  // set up simulation operations
    ...
    simulation_0.saveState("C:\\Users\\USER\\OneDrive - Cranfield University\\IRP\\optimisation_new\\GCS\\"+save_filename+".sim");
  }
}
