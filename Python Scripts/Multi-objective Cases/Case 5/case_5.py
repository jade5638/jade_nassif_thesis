...
#MODIFY THE GENE SPACE VARIABLE HERE SO THAT WE RESTRICT M_DESIGN TO A CERTAIN RANGE
# Mmin=5.5 # avg beta_0 is 13.963740100504685
# Mmax=7 # avg beta_0 is 16.091844524748304
# gene_space[0]={'low': Mmin, 'high': Mmax}
...
def fitness_func(ga_instance,solution,solution_idx):
        ...
        global base_drag_m5, base_drag_m8,base_lift_m5,base_lift_m8
        ...
        if check_constraint(X1,X2) :
            ...
            lift_fitness=((L_M8*0.5+L_M5*0.5)/(0.5*base_lift_m5+0.5*base_lift_m8))
            # get drag
            ...
            lift_fitness=0
            drag_fitness=0
        return lift_fitness,drag_fitness
...
# do the 10 cases automatically through a loop
