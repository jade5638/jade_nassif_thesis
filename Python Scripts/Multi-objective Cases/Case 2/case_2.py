...
def fitness_func(ga_instance,solution,solution_idx):
        ...
        if check_constraint(X1,X2) :
            ...
            v_eff_fitness=volume_fitness**(2/3)/s_wet_fitness
            ...
            v_eff_fitness=0
            drag_fitness=0
        return v_eff_fitness,drag_fitness
...
for solution in pareto_solutions:
    ...
    Volume.append(float(volume_surrogate.predict_values(solution)))
    s_wet.append(float(s_wet_surrogate.predict_values(solution)))

pareto_df['s_wet']=s_wet
pareto_df['Volume']=Volume
pareto_df['L_M5'] = L_M5
pareto_df['L_M8'] = L_M8
pareto_df['D_M5'] = D_M5
pareto_df['D_M8'] = D_M8
