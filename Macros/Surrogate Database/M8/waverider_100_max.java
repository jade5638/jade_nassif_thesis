...
public class waverider_100_max extends StarMacro {

  // Set name of waverider geometry 
  String waverider_name="waverider_100";
  String cad_filename= waverider_name + ".step";
  String save_filename="waverider_100_max";

  // Define flow conditions
  double mach=8;
  double velocity=2416; // m/s
  double ref_pressure=1169; // Pa
  double static_temp=226.65; //Kelvin
  double ref_density=1.797e-2; // kg/m3
  ...
  AmrSolver amrSolver_0 = 
    ...
    monitorIterationStoppingCriterionMaxLimitType_0.getLimit().setValueAndUnits((n_refinements+1)*amr_iter_frequency, units_10);
  ...
  // set up simulation operations
    ...
    simulation_0.saveState("C:\\Users\\USER\\OneDrive - Cranfield University\\IRP\\optimisation_new\\max_setup\\"+save_filename+".sim");
  }
}
